...
const columns = [
  ...
  { key: 'stock', label: 'STOCK', className: 'whitespace-nowrap font-semibold tabular-nums text-[#364b75]', value: (row) => row.stock }
]

const ExpiringAlertsSection = ({ section, rows, isOpen, isLoading, onToggle }) => (
  <AlertSectionCard
...
export default ExpiringAlertsSection
